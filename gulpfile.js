...
export const html = () =>
    gulp
        ...
        .pipe(
            fileInclude({
                prefix: '@@',
                basepath: 'src/components/', // <---- HERE: Set basepath here
            })
        )
        .pipe(
            htmlmin({
...
// Сборка
export const build = gulp.series(clean, gulp.parallel(styles, html, assets, fonts, imagesToWebp, imagesToMobileWebp));
